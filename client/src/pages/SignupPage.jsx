        ...
        <div className="min-h-screen bg-gray-50 flex flex-col relative" style={{ fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>
            ...
            <div className="flex-1 flex items-center justify-center px-6 py-12 relative">
                <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <div className="hidden md:block">
                        <div className="glass-card rounded-3xl p-8 border border-white/60">
                            ...
                            <p className="text-gray-500 mb-6">
                                Build a consistent practice routine, then measure progress across every mock session.
                            </p>
                            <div className="space-y-4">
                                {[
                                    ...
                                    <div key={item} className="flex items-center gap-3 text-sm text-gray-600">
                                        <span className="w-2.5 h-2.5 rounded-full bg-[#6ece3b]" />
                                        {item}
                                    </div>
                                ))}
                            </div>
                    ...
                    <div className="glass-panel rounded-3xl p-8 md:p-10 w-full my-auto">
                    ...
                    <p className="mt-8 text-center text-sm text-gray-600 font-medium">
                        ...
                        <button onClick={() => navigate("/login")} className="text-[#1caee4] hover:text-[#169ad0] font-bold">
                            Sign in
                        </button>
                    </p>
